$(function(){$.fn.preloader=function(a){function k(d){if(g[d]==false){i++;a.oneachload(b[d]);g[d]=true}if(a.imagedelay==0&&a.delay==0)$(b[d]).css("visibility","visible").animate({opacity:1},700);else if(a.delay==0){j(b[d],e);e+=a.imagedelay}else if(a.imagedelay==0)j(b[d],a.delay);else{j(b[d],a.delay+e);e+=a.imagedelay}}function l(){h=setInterval(function(){if(i>=g.length){clearInterval(h);a.ondone()}else if(a.mode=="parallel")for(c=0;c<b.length;c++)b[c].complete==true&&k(c);else if(b[c].complete==
