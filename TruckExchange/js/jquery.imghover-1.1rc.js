...
(function($) {
    $.fn.ibox = function() {
        ...
        ////////////////////
        var img = this;
        img.parent().parent().parent().parent().parent().append('<div id="ibox" style="position:absolute;	z-index:10000;" />');
        var ibox = $('#ibox');
        var elX = 0;
        var elY = 0;
        ...
        img.each(function() {
            ...
            el.mouseenter(function() {
                ...
                ibox.stop().fadeTo(200, 1, function() {
                    $(this).animate({top: '-='+(resize/2), left:'-='+wh},400).children('img').animate({scale:'1.4'},400);
                });
            });
