...
jQuery.fn.slideViewerPro = function(settings) {
	  settings = jQuery.extend({
			...
			thumbsBorderWidth: 3,
			buttonsWidth: 30,
			galBorderColor: "#68b55e",
			thumbsBorderColor: "#ccc",
			thumbsActiveBorderColor: "#68b55e",
			...
			leftButtonInner: "<img src='images/ad_prev.png'  />", //could be an image "<img src='images/larw.gif' />" or an escaped char as "&larr";
			rightButtonInner: "<img src='images/ad_next.png'  />", //could be an image or an escaped char as "&rarr";
			autoslide: false,
			typo: false,
			typoFullOpacity: 0,
			shuffle: false
