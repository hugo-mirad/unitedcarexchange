<%@ Control Language="C#" AutoEventWireup="true" CodeFile="RegPageUser.ascx.cs" Inherits="UserControl_RegPageUser" %>
    ...
    <tr>
        <td style="text-align: right;" align="left">
            ...
            <label style="padding: 2px 4px 0 6px; float: none;">
                <b>Customer Services: <span style="color: #ff6600"><a href="ContactUs.aspx">888-786-8307</a></span>
                </b>
            </label>
        </td>
    </tr>
