    ...
    public class FilterCars
    {
        public IList<UsedCarsInfo> FilterSearch(CarsInfo.CarsFilter objCarsFilter)
        {
            ...
            try
            {
                ...
                dbDatabase.AddInParameter(dbCommand, "@VehicleType", DbType.String, objCarsFilter.VehicleType);

                dbDatabase.AddInParameter(dbCommand, "@Category", DbType.String, objCarsFilter.Category);
