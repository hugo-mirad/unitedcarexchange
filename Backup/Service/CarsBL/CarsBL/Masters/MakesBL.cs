    ...
    public class MakesBL
    {
        ...
        private void AssignMakesInfoList(IDataReader MakesInfoDataReader, MakesInfo MakesInfo)
        {
            try
            {
                ...
                MakesInfo.Priority = Convert.ToString(MakesInfoDataReader["PriorityID"]);
                MakesInfo.RvtypeID = Convert.ToString(MakesInfoDataReader["RVTYPE"]);
                MakesInfo.VehicleType = Convert.ToString(MakesInfoDataReader["VehicleType"]);
