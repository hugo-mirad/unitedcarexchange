<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SellRegiOld.aspx.cs" Inherits="SellRegiOld"
                                        ...
                                        <div class="newsflash">
                                            ...
                                            <div class="block first " style="position: relative">
                                                ...
                                                <div style="position: absolute; top: 0px; left: 25px; width: 119px; height: 120px;">
                                                    <%-- <asp:ImageButton ID="ImgbtnSellcar" runat="server" ImageUrl="~/imagesOld/sellCar.jpg"
        ...
        <div class="popupBody" style="display: block" id="SuccessAlert">
            <div>
                <h1 class="H2" style="padding: 10px 0 20px 0">
                    ALERT!</h1>
                <p class="pp">
                    You have already Logged in mobicarz.com. if you want to register again
