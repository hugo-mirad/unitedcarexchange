<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddNewChargeback.aspx.cs"
    Inherits="AddNewChargeback" %>
    ...
    <script type="text/javascript" language="javascript">
         ...
         function ValidateUserData()
        {
            ...
            var valid=true;
             ...
             if((document.getElementById('<%=txtCustName.ClientID%>').value.trim() == "") && (document.getElementById('<%=txtPhoneNumber.ClientID%>').value.trim() == "") && (document.getElementById('<%=txtVehicleID.ClientID%>').value.trim() == "")) 
             {
                document.getElementById('<%= txtCustName.ClientID%>').focus();
                alert("Please enter name or phone or carid");
                document.getElementById('<%= txtCustName.ClientID%>').focus();
                 valid = false; 
                 return valid;      
             }                           
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:TextBox ID="txtPhoneNumber" Width="150px" CssClass="input2 number" MaxLength="10"
                                    runat="server" TabIndex="0" onkeypress="return isNumberKey(event)"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td>
