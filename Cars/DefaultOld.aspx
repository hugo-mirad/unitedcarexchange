...
<![endif]-->
    <style>
        .usual ul li.tab1 a
        {
            ...
            color: #444;
            font-weight: bold;
            background: url(imagesOld/AccordionTab0.gif) repeat-x;
        }
    </style>
...
<body id="page1">
    ...
    <div class="banner-block" >
        <div class="banner">
            <!-- Search Start  -->
            <div class="search-block" id ="Div1">
                <h3>
                    <img src="images/searchCars.jpg" /></h3>
                    <div style="width: 85%;">
                    <h4>
                        Make:</h4>
                    <select id="make" runat="server" >
                        <option value="">Loading...</option>
                    </select>
                    <h4>
                        Model:</h4>
                    <select id="model" runat="server" >
                ...
                <div class="clear"></div>
                <a href="javascript:search();" class="searchButton"  ></a>
            </div>
            </div>
           <!-- Search End  -->
                    <div class="tollfree">
    ...
    <!-- bannerLogos-block  Start -->
    <div class="bannerLogos-block">
        <div class="bannerLogos">
        </div>
    </div>
    <!-- bannerLogos-block  End -->
    <div class="box970">
        <h1 class="welcome-h1">
            Welcome to India Car Exchange. An online platform where car buyers and sellers can search, buy, sell and come together to talk about their Used Cars.</h1>
    </div>
            ...
            <div id="column-right" class="column-indent">
                            <div class="indent">
                                <div class="wrapper">
                                    ...
                                    <!-- Ads Section Start  -->
                                    <div id="div88X720" runat="server" style="height: 88px; width: 705px; margin: 10px 0 0 0;
    ...
    <div class="ZipVal-holder">
        <div id="ZipVal">
            <table width="100%" align="center" style="background-color: #ffffff;">
                <tr>
                    <td colspan="2" style="background: url(images/liBAck.jpg) 0 0; height: 20px;
