                                        ...
                                        <div class=" col-md-12">
                                            <div style="width: 340px; float: right; padding: 0; text-align: right; padding-top: 40px">
                                                <asp:UpdatePanel ID="updtpnlSold" runat="server">
                                                    <ContentTemplate>
                                                        <asp:Button ID="btnActive" runat="server" CssClass="button1" Text="Activate" Style="float: right; margin-left: 8px;"
                                                            Visible="false" OnClick="btnActive_Click" />
                                                        <asp:Button ID="btnSold" runat="server" CssClass="button1" Text="Sold" Style="float: right; margin-left: 8px;"
                                                            Visible="false" OnClick="btnSold_Click" />
                                                        <asp:Button ID="btnWithdraw" runat="server" CssClass="button1" Text="Withdraw" Style="float: right; margin-left: 8px;"
                                                            Visible="false" OnClick="btnWithdraw_Click" />
                                                    </ContentTemplate>
                                                </asp:UpdatePanel>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="block-inner white block-shadow">
                                                ...
                                                <div class="form-section">
                                                    <div class="block-title">
                                                        <h2>Seller Information For Display</h2>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-sm-6 col-md-5">
                                                            <div class="form-group">
                                                ...
                                                <div class="form-section">
                                                    <div class="block-title">
                                                        <h2>Vehicle Information <small><i class="non">(You may add or modify these later)</i></small></h2>
                                                    </div>
                                                    <div class="row">
                                                ...
                                                <div class="form-section">
                                                    <div class="block-title">
                                                        <h2>Vehicle Description <small><i class="non">(You may add or modify these later)</i></small></h2>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-sm-11 col-md-11">
                                                            <div class="form-group">
                                                                <span id="oeFormsellingPointsContainer"><span id="sellingPointSentence"><span id="sellingPointCharCount">1000</span> characters left</span><br />
                                                                    ...
                                                                    <p>
                                                                        ...
                                                                        Kelley Blue Book value and anything else that will help sell your vehicle.</i>
                                                                    </p>
                                                                </span>
                                                            </div>
                                                        </div>
                                                                ...
                                                                <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                                                                    <ContentTemplate>
                                                                        ...
                                                                        <div class="not" id="divlblMultiSite" runat="server" style="display: block;">
                                                                            <asp:Label ID="lblExistUrlRes" runat="server"></asp:Label>
                                                                        </div>
                                                                    </ContentTemplate>
                                                                </asp:UpdatePanel>
