<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Dealerregistration.aspx.cs"
    Inherits="Dealerregistration" %>
    ...
    <script type="text/javascript" language="javascript">
     ...
     debugger;
            ...
            if(document.getElementById('<%= ddlPackage.ClientID%>').value == "0") {
              ...
              if(document.getElementById('<%= txtDealerID.ClientID%>').value.length < 1) {
                document.getElementById('<%= txtDealerID.ClientID%>').focus();
                document.getElementById('<%=txtDealerID.ClientID%>').value = "";
                alert("Enter dealer id");
                valid = false;            
                 return valid;     
            }
            
             if((document.getElementById('<%= txtDealerID.ClientID%>').value.length > 0) && (document.getElementById('<%= txtDealerID.ClientID%>').value.length < 4))
            {
                document.getElementById('<%= txtDealerID.ClientID%>').focus();
                document.getElementById('<%=txtDealerID.ClientID%>').value = "";
                alert("dealer id length must be 4 characters");
                valid = false;            
                 return valid;     
            }      
                                ...
                                <table style="width: 99%; margin-left: 5px;" cellpadding='1' cellspacing='0'>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <asp:TextBox ID="txtDealerID" runat="server" CssClass="input3" MaxLength="6" onkeypress="return isKeyNotAcceptSpace(event);"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="width: 110px">
                                                            ...
                                                            <div id="divcard" runat="server">
                                                                <table border="0" cellpadding="1" cellspacing="1" style="width: 55%; margin: 0 30px 0 0;
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <asp:DropDownList ID="ExpMon" Style="width: 80px;" runat="server">
