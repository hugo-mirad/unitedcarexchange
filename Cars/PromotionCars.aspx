...
<head runat="server">
    ...
    <title>Search Used Cars, Buy & Sell Used Cars and New Cars Online at mobicarz.com
    </title>
    <link rel="shortcut icon" href="images/favicon.ico" type="image/x-icon" />
    <link href="http://www.mobicarz.com/promotion/css.css" rel="stylesheet"
        type="text/css" />
    <link href="css/style.css" rel="stylesheet" type="text/css" />

    <script type="text/javascript" src="http://www.mobicarz.com/promotion/jquery.min.js"></script>

    <script type="text/javascript" src="http://www.mobicarz.com/promotion/jquery.easing.1.3.js"></script>

    <script type="text/javascript" src="http://www.mobicarz.com/promotion/jquery.vticker.js"
        ...
        <div id="main">
            ...
            <div id="header">
                <a href="http://mobicarz.com">
                    <img src="http://www.mobicarz.com/images/logo2.png" id="logo" alt=""></a>
                <div class="loginStat">
                ...
                <div id="search-box">
                    <div class="inner">
                        <div id="searchFormHolder" class="wrapper">
                            ...
                            <asp:LinkButton class="sellMyCar" runat="server" PostBackUrl="http://www.mobicarz.com/Packages.aspx">
                                <img src="http://www.mobicarz.com/images/sellmycarToday.png" /></asp:LinkButton>
                        </div>
                        <%--www.mobicarz.com/Packages.aspx--%>
                        <!-- <b><a href="#" onclick="document.getElementById('car-form').submit()"></a></b> -->
                    </div>
                </div>
                <div id="loopedSlider">
                    <div class="container">
                        <img src="http://www.mobicarz.com/images/slides/image-08.jpg" width="630"
                            height="389">
                    </div>
                </div>
            </div>
                    ...
                    <tr>
                        ...
                        <td>
                            <h4>
                                ...
                                &nbsp;
                                <asp:Label ID="lblCity1" runat="server"></asp:Label>- Welcome to MobiCarz</h4>
                            <p>
                            ...
                            <p>
                                ...
                                <h2 style="font-size: 13px; font-weight: normal; margin: 4px 0">
                                    <b>Tags: </b>&nbsp;<a href="http://www.mobicarz.com/Packages.aspx" target="_blank"
                                        style="color: #333; text-decoration: none;">Best way to sell my used car</a>&nbsp;
                                    | &nbsp; <a href="http://www.mobicarz.com/Packages.aspx" target="_blank" style="color: #333;
                                        text-decoration: none;">Fastest way to sell my used car</a>&nbsp; | &nbsp; <a href="http://www.mobicarz.com/Packages.aspx"
                                            target="_blank" style="color: #333; text-decoration: none;">How to sell my used
                                            car</a>&nbsp; | &nbsp; <a href="http://www.mobicarz.com/Packages.aspx" target="_blank"
                                            ...
                                            <tr>
                                                <td style="width: 65%; border-right: #fedaa0 1px dotted; padding: 10px;">
                                                    ...
                                                    <asp:Button ID="LinkButton1" Text="LIST YOUR CAR NOW" class="button1" runat="server"
                                                        PostBackUrl="http://www.mobicarz.com/Packages.aspx" />
                                                </td>
                                                <td style="padding: 10px;">
                                                    ...
                                                    View our
                                                    <asp:LinkButton ID="Button1" Text="Advertising Plans" class="aa" runat="server" PostBackUrl="http://www.mobicarz.com/Packages.aspx" />
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
