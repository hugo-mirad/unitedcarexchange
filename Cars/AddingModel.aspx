<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddingModel.aspx.cs" Inherits="AddingModel" %>
...
<head id="Head1" runat="server">
	...
	$(function() {
	   ...
	   function ShowAddAgent() {           
            ...
            document.getElementById('<%= txtMakeModelName.ClientID%>').value = "";
          ...
          function ValidateAddModel()
          {
	        ...
	        if(document.getElementById('<%= ddlMake.ClientID%>').value == "0") {
              ...
              if(document.getElementById('<%= txtMakeModelName.ClientID%>').value.length < 1) {
                document.getElementById('<%= txtMakeModelName.ClientID%>').focus();
    ...
    <div class="main">
        ...
        <div align="right" style="width: 420px">
            <asp:LinkButton ForeColor="#BC0101" ID="lnkAddUSer" runat="server" OnClientClick="return ShowAddAgent()"
                CssClass="link" Text="Add Model"></asp:LinkButton>
                            ...
                            <ContentTemplate>
                                <table class="grid1 " cellpadding="0" cellspacing="0" style="position: absolute;
                                    ...
                                    <tr class="tbHed">
                                        ...
                                        <td align="left">
                                            <asp:LinkButton ID="lnkbtnModelName" runat="server" Text="Model Name &darr; &uarr;"
                                                OnClick="lnkbtnModelName_Click"></asp:LinkButton>
                                        </td>
                                    </tr>
                                </table>
                            </ContentTemplate>
                                ...
                                <ContentTemplate>
                                    ...
                                    <asp:GridView Width="400px" ID="grdUserDetails" runat="server" CellSpacing="0" CellPadding="0"
                                        ...
                                        <Columns>
                                            <asp:TemplateField>
                                                <ItemTemplate>
                                                    <asp:Label ID="lblMakeId" runat="server" Text='<%# Eval("make") %>'></asp:Label>
                                                </ItemTemplate>
                                                <ItemStyle HorizontalAlign="Left" Width="200px" />
                                            </asp:TemplateField>
                                            <asp:TemplateField>
                                                <ItemTemplate>
                                                    <asp:Label ID="lblMakeName" runat="server" Text='<%# Eval("model") %>'></asp:Label>
                                                </ItemTemplate>
                        ...
                        <td width="100%" colspan="2" align="center">
                            <table border="0" cellpadding="0" cellspacing="0" style="width: 98%; margin: 0 auto">
                                ...
                                <tr>
                                    ...
                                    <td style="width: 28%">
                                        <asp:DropDownList ID="ddlMake" Width="101%" CssClass="input1" runat="server" AppendDataBoundItems="true">
                                        </asp:DropDownList>
                                        <%-- <asp:TextBox MaxLength="20" CssClass="input1" ID="TextBox1" runat="server"></asp:TextBox>--%>
                                    </td>
                                ...
                                <tr>
                                    <td style="width: 18%">
                                        Model Name<span class="star">*</span>
                                    </td>
                                    <td style="width: 28%">
                                        <asp:TextBox MaxLength="25" CssClass="input1" ID="txtMakeModelName" runat="server"></asp:TextBox>
                                    </td>
                                    <td style="width: 6%; padding: 0">
                                        &nbsp;
                                    </td>
                    ...
                    <tr>
                        <td colspan="4" style="padding-top: 15px;">
                            <div style="width: 240px; margin: 0 auto;">
                                <asp:Button ID="btnAddModel" runat="server" CssClass="g-button g-button-submit" Text="Submit"
                                    OnClientClick="return ValidateAddModel();" OnClick="btnAddModel_Click" />
