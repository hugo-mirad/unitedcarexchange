...
<body>
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-12 col-md-12">
                                                        ...
                                                        <div class=" newFileUploadControler">
                                                            <%--  <asp:Button ID="Button1" runat="server" class="btn btn-danger floatR" Text="Add photos later"
                                        Style="float: right; margin-left: 10px;" OnClick="btnContinue_Click" />&nbsp;
    ...
    <div class="alert" style="display: block; width: 450px" id="divEditSuccess">
        <h4 id="H5">
            Alert
            <asp:Button ID="Button3" class="cls" runat="server" Text="" BorderWidth="0" />
            <!-- <div class="cls">
            </div> -->
        </h4>
        <div class="data">
            <p class="pp">
                Changes have been incorporated successfully. Thank you.
            </p>
            <asp:Button ID="btnGo" class="btn btn-primary2 btn-sm" runat="server" Text="Ok" OnClick="btnGo_Click" />
        </div>
    </div>
    ...
    <div class="alert" runat="server" style="display: none" id="popupBody1">
        <h4 id="H4">
            Alert
        ...
        <div class=" data">
            ...
            <asp:Button ID="btnOk" class="btn btn-primary2" runat="server" Text="Ok" OnClick="btnOk_Click" />
        </div>
    </div>
    <!-- Alerts End  -->
