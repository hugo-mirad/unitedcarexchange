...
public class GeneralFunc
{
    ...
    public static void SaveCookieData(string cookievalue, string IPAddress, DateTime SatrtTime, DateTime EndTime, bool Islogin, string Result, string zip, string cookieName)
    {
        VisitSiteLog objVisitSiteLog = new VisitSiteLog();
        objVisitSiteLog.CookieDetails(cookievalue, IPAddress, SatrtTime, EndTime, Islogin, Result, zip, cookieName);
