<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Days60CallsReview.aspx.cs" Inherits="Days60CallsReview" %>
                                            ...
                                            <table class="grid1 " cellpadding="0" cellspacing="0" style="position: absolute;
                                                ...
                                                <tr class="tbHed">
                                                    ...
                                                    <td width="65px" align="left">
                                                        <asp:LinkButton ID="lnkWcStatus" runat="server" Text="60DC St &darr; &uarr;" OnClick="lnkWcStatus_Click"></asp:LinkButton>
                                                    </td>
                                                    <td width="65px" align="left">
                                                    ...
                                                    <td width="65px" align="left">
                                                        <asp:LinkButton ID="lnkWCDt" runat="server" Text="60DC Dt &darr; &uarr;" OnClick="lnkWCDt_Click"></asp:LinkButton>
                                                    </td>
                                                    <td width="80px" align="left">
                                                        <asp:LinkButton ID="lnkWCBy" runat="server" Text="60DC By &darr; &uarr;" OnClick="lnkWCBy_Click"></asp:LinkButton>
                                                    </td>
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField>
                                                            <ItemTemplate>
                                                                ...
                                                                <asp:HiddenField ID="hdnWCCallID" runat="server" Value='<%# Eval("Days60CallID")%>' />
                                                                <asp:HiddenField ID="hdnWCStatus" runat="server" Value='<%# Eval("Days60Status")%>' />
                                                            </ItemTemplate>
                                        ...
                                        <ContentTemplate>
                                            <table class="grid1 " cellpadding="0" cellspacing="0" style="position: absolute;
                                                ...
                                                <tr class="tbHed">
                                                    ...
                                                    <td width="65px" align="left">
                                                        <asp:LinkButton ID="lnkbtnRvWCStatusSort" runat="server" Text="60DC St &darr; &uarr;"
                                                    ...
                                                    <td width="65px" align="left">
                                                        <asp:LinkButton ID="lnkbtnRVWCDTSort" runat="server" Text="60DC Dt &darr; &uarr;" OnClick="lnkbtnRVWCDTSort_Click"></asp:LinkButton>
                                                    </td>
                                                    <td width="80px" align="left">
                                                        <asp:LinkButton ID="lnkbtnRVWCBYSort" runat="server" Text="60DC By &darr; &uarr;" OnClick="lnkbtnRVWCBYSort_Click"></asp:LinkButton>
                                                    </td>
                                                    <td width="90px" align="left">
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField>
                                                            <ItemTemplate>
                                                                ...
                                                                <asp:HiddenField ID="hdnRvWCCallID" runat="server" Value='<%# Eval("Days60CallID")%>' />
                                                                <asp:HiddenField ID="hdnRvWCStatus" runat="server" Value='<%# Eval("Days60Status")%>' />
                                                            </ItemTemplate>
                                                            <ItemStyle HorizontalAlign="Left" Width="65px" />
                                                        </asp:TemplateField>
                                                        <asp:TemplateField>
