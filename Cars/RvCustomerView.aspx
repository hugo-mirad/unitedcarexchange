<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RvCustomerView.aspx.cs" Inherits="RvCustomerView" ValidateRequest="false"%>
            ...
            <tr>
                ...
                <td style="width: 300px; vertical-align: top">
                    ...
                    <asp:Button ID="btnAddNewCBNotice" runat="server" Text="Add CB Notice" CssClass="g-button but1"
                        Width="300px" OnClick="btnAddNewCBNotice_Click" />
                                ...
                                <div class="box1">
                                    ...
                                    <table cellpadding='1' cellspacing='0' style="width: 99%; margin: 0 0 0 5px">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:Label ID="lblWaterCapacity" runat="server"></asp:Label>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                            ...
                                            <td>
                                                <asp:Label ID="lblTowingCapacity" runat="server"></asp:Label>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                            ...
                                            <td>
                                                <asp:Label ID="lblDryWeight" runat="server"></asp:Label>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:Label ID="lblAirConditioners" runat="server"></asp:Label>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                            ...
                                            <td>
                                                <asp:Label ID="lblSleepingCapacity" runat="server"></asp:Label>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                            ...
                                            <td>
                                                <asp:Label ID="lblSlideOuts" runat="server"></asp:Label>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                            ...
                                            <td>
                                                <asp:Label ID="lblEngineManufacturer" runat="server"></asp:Label>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                            ...
                                            <td>
                                                <asp:Label ID="lblEngineType" runat="server"></asp:Label>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                ...
                                <div class="box1" style="width: 100%">
                                    ...
                                    <table style="width: 99%; margin: 0 auto" cellpadding="1" cellspacing="0">
                                        <tr>
                                            ...
                                            <td>
                                                <asp:Label ID="lblGeneralFeature" runat="server"></asp:Label>
                                            </td>
                                        </tr>
                                    </table>
                                </div>
                                            ...
                                            <td>
                                                <asp:UpdatePanel ID="updtpnlTransaction" runat="server">
                                                    <ContentTemplate>
                                                        ...
                                                        <asp:LinkButton ID="lnkCarTransactionDetails" runat="server" Text="RV Transaction Details"
