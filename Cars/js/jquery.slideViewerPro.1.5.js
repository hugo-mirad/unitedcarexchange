...
jQuery(function(){
jQuery("div.svwp").prepend("<img src='http://www.mobicarz.com/images/svwloader.gif' class='ldrgif' alt='loading...'/ >"); //change with YOUR loader image path   
});
var j = 0;
jQuery.fn.slideViewerPro = function(settings) {
	  settings = jQuery.extend({
			...
			thumbsBorderWidth: 3,
			buttonsWidth: 30,
			galBorderColor: "#ffb619",
			thumbsBorderColor: "#ccc",
			thumbsActiveBorderColor: "#ffb619",
			buttonsTextColor: "#ffb619",
			...
			leftButtonInner: "<img src='http://www.mobicarz.com/images/ad_prev.png'  />", //could be an image "<img src='images/larw.gif' />" or an escaped char as "&larr";
			rightButtonInner: "<img src='http://www.mobicarz.com/images/ad_next.png'  />", //could be an image or an escaped char as "&rarr";
			autoslide: false,
			typo: false,
			typoFullOpacity: 0,
			shuffle: false
    ...
    .wrap(jQuery("<div style='width:"+ pictWidth +"px; overflow: hidden; position: relative; top: 0; left: 0'>"));
		...
		container.each(function(i) {
			...
			jQuery("a#left" + j).css({display: "block", textAlign: "center", width: settings.buttonsWidth + "px" , height: thumbsHeight+"px",  margin: -(thumbsHeight-settings.thumbsTopMargin+17) +"px 0 20px "+lbttLeftMargin+"px", textDecoration: "none", lineHeight: thumbsHeight+"px", color: settings.buttonsTextColor});
			jQuery("a#right" + j).css({display: "block", textAlign: "center", width: settings.buttonsWidth + "px", height: thumbsHeight+"px" , margin: -(thumbsHeight+17) +"px 0 20px "+rbttLeftMargin+"px", textDecoration: "none", lineHeight: thumbsHeight+"px", color: settings.buttonsTextColor});			
