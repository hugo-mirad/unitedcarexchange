...
<table style="text-align: right; float: right; width: 100%;">
    <tr>
        <td id="ChangeLanguage" runat="server" style="width: 195px; text-align: left">
            <div style="display:none"><asp:Label ID="lblLang" runat="server" class="login" Style="background: none; padding-right: 5px;">Change language:</asp:Label>
            <asp:LinkButton ID="lnbtnLang" runat="server"  PostBackUrl="http://esp.mobicarz.com" Style="font-size: 11px;">SPANISH</asp:LinkButton>
            </div>
        </td>
        <td style="text-align: right;" align="left">
            <label id="myaccDiv" runat="server" style="text-align: right; float: none;">
                <asp:LinkButton ID="lnkMyaccount" runat="server" Text="My Account" PostBackUrl="http://www.mobicarz.com/account.aspx"></asp:LinkButton>&nbsp;|&nbsp;
            </label>
