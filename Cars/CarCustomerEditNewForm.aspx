<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CarCustomerEditNewForm.aspx.cs"
    Inherits="CarCustomerEditNewForm" ValidateRequest="false"%>
  ...
  function TransfersInfoBinding(){
    ...
    function youfunction(){
        //alert('ok')
         ...
         //console.log($('#feat input[type=checkbox]'));
        ...
        <h1 class="h1">
            ...
            <div style="width: 400px; float: right; margin-right: 0;">
                <asp:UpdatePanel ID="UpdatePane1BtnSalesUpdate" runat="server">
                    <ContentTemplate>
                        <asp:Button ID="btnBack" runat="server" CssClass="g-button g-button-submit" Text="Back"
                            OnClientClick="return ChangeValues();" OnClick="btnBack_Click" Style="float: right;
                            margin: 0 6px 0 0;" />
                        <asp:Button ID="btnUpdate" runat="server" CssClass="g-button g-button-submit" Text="Save"
                            OnClientClick="return ValidateSavedData();" OnClick="btnUpdate_Click" Style="float: right;
                            margin: 0 6px 0 0;" Enabled="false" />
                    </ContentTemplate>
                </asp:UpdatePanel>
            </div>
        </h1>
            ...
            <tr>
                <td width="400px">
                    <h4 class="h4">
                        ...
                        <asp:DropDownList ID="ddlPackage" runat="server" Enabled="false">
                        </asp:DropDownList>
                    </h4>
                </td>
