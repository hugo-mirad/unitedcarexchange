<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SalesAgentReport.aspx.cs"
    Inherits="SalesAgentReport" %>
        ...
        <table style="width: 100%;">
            <tr>
                <td style="vertical-align: top;">
                        ...
                        <asp:UpdatePanel ID="updtPnlHeaders" runat="server">
                            <ContentTemplate>
                                <table class="grid1 " cellpadding="0" cellspacing="0" style="position: absolute;
                                    top: 2px; padding-top: 2px; width: 860px; background: #fff;">
                                    <tr class="tbHed2">
                                        <td align="left" style="width: 132px">
                                            <%--<asp:LinkButton ID="lnkAgentNameSort" runat="server" Text="Agent Code &#8659" OnClick="lnkAgentNameSort_Click"></asp:LinkButton>--%>
                                            Agent Code
                                        </td>
                                        <td align="left" style="width: 132px">
                                            <%--<asp:LinkButton ID="lnkAgentFullName" runat="server" Text="Name &darr; &uarr;" OnClick="lnkAgentFullName_Click"></asp:LinkButton>--%>
                                            Agent Name
                                        </td>
                                        <td style="text-align: center; padding: 0; width: 325px">
                                            <table class="tbHed3" style="text-align: center" cellpadding="0" cellspacing="0">
                                                <tr>
                    ...
                    <div style="width: 860px; overflow-x: hidden; margin-top: 0px; padding: 48px 3px 3px 3px;
                        ...
                        <asp:Panel ID="pnl1" Width="100%" runat="server">
                            <asp:UpdatePanel ID="UpdPnlGrid" runat="server">
                                <ContentTemplate>
                                    ...
                                    <asp:GridView Width="860px" ID="grdAgentData" runat="server" CellSpacing="0" CellPadding="0"
                                        CssClass="grid1" AutoGenerateColumns="False" GridLines="None" ShowHeader="false"
                                        OnRowCommand="grdAgentData_RowCommand" OnRowDataBound="grdAgentData_RowDataBound"
                                        ShowFooter="true">
                                        ...
                                        <Columns>
                                            <asp:TemplateField>
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="lnkbtnAgentCode" runat="server" Text='<%# objGeneralFunc.WrapTextByMaxCharacters(objGeneralFunc.ToProper(DataBinder.Eval(Container.DataItem,"American_name")),15) %>'
                                                        CommandArgument='<%# Eval("Sale_Agent_Id")%>' CommandName="ShowSales"></asp:LinkButton>
                                                </ItemTemplate>
                                                <FooterTemplate>
                                                    <asp:Label ID="lblFooterTotal" runat="server" Text="Total"></asp:Label>
                                                </FooterTemplate>
                                                <ItemStyle HorizontalAlign="Left" Width="130px" />
                                            </asp:TemplateField>
                                            <asp:TemplateField>
                                                <ItemTemplate>
                                                    <asp:Label ID="lblAgentFullName" runat="server" Text='<%# objGeneralFunc.WrapTextByMaxCharacters(objGeneralFunc.ToProper(DataBinder.Eval(Container.DataItem,"Agent_Name")),15) %>'></asp:Label>
                                                </ItemTemplate>
                                                <ItemStyle HorizontalAlign="Left" Width="130px" />
                                            </asp:TemplateField>
                                            <asp:TemplateField>
                                                <ItemTemplate>
                                                    ...
                                                    <asp:Label ID="lblCountSilver" runat="server" Text='<%# Eval("SilverDelux")%>'></asp:Label>
                                                </ItemTemplate>
                                                <FooterTemplate>
                                                    <asp:Label ID="lblFooterCountSilver" runat="server"></asp:Label>
                                                </FooterTemplate>
                                            ...
                                            <asp:TemplateField>
                                                <ItemTemplate>
                                                    <%--<asp:Label ID="lblCount" runat="server" Text='<%# Eval("Count")%>'></asp:Label>--%>
                                                    <asp:Label ID="lblCountGold" runat="server" Text='<%# Eval("GoldDelux")%>'></asp:Label>
                                                </ItemTemplate>
                                                <FooterTemplate>
                                                    <asp:Label ID="lblFooterCountGold" runat="server"></asp:Label>
                                                </FooterTemplate>
                                                <ItemStyle HorizontalAlign="Center" Width="60px" />
                                                <FooterStyle HorizontalAlign="Center" />
                                            </asp:TemplateField>
                                            <asp:TemplateField>
                                                <ItemTemplate>
                                                    <%--<asp:Label ID="lblCount" runat="server" Text='<%# Eval("Count")%>'></asp:Label>--%>
                                                    <asp:Label ID="lblCountPlatinum" runat="server" Text='<%# Eval("PlatinumDelux")%>'></asp:Label>
                                                </ItemTemplate>
                                                <FooterTemplate>
                                                    <asp:Label ID="lblFooterCountPlatinum" runat="server"></asp:Label>
                                                </FooterTemplate>
                                                <ItemStyle HorizontalAlign="Center" Width="60px" />
                                                <FooterStyle HorizontalAlign="Center" />
                                            </asp:TemplateField>
                                            <asp:TemplateField>
                                                <ItemTemplate>
                                                    <%--<asp:Label ID="lblCount" runat="server" Text='<%# Eval("Count")%>'></asp:Label>--%>
                                                    <asp:Label ID="lblCountBasic" runat="server" Text='<%# Eval("Other")%>'></asp:Label>
                                                </ItemTemplate>
                                                <FooterTemplate>
                                                    <asp:Label ID="lblFooterCountBasic" runat="server"></asp:Label>
                                                </FooterTemplate>
                                                <ItemStyle HorizontalAlign="Center" Width="60px" />
                                                <FooterStyle HorizontalAlign="Center" />
                                            </asp:TemplateField>
                                            <asp:TemplateField>
                                                <ItemTemplate>
                                                    <%--<asp:Label ID="lblCount" runat="server" Text='<%# Eval("Count")%>'></asp:Label>--%>
                                                    <asp:Label ID="lblCountTotal" runat="server" Text='<%# Eval("Total")%>'></asp:Label>
                                                    <asp:HiddenField ID="hdnCountTotal" runat="server" Value='<%# Eval("Total")%>' />
                                                </ItemTemplate>
                                                <FooterTemplate>
                                                    <asp:Label ID="lblFooterCountTotal" runat="server"></asp:Label>
                                                </FooterTemplate>
                                                <ItemStyle HorizontalAlign="Center" Width="60px" />
                                                <FooterStyle HorizontalAlign="Center" />
                                            </asp:TemplateField>
                                            <asp:TemplateField>
                                                <ItemTemplate>
                                                    <%--<asp:Label ID="lblCount" runat="server" Text='<%# Eval("Count")%>'></asp:Label>--%>
                                                    <asp:Label ID="lblAllAmount" runat="server"></asp:Label>
                                                    <asp:HiddenField runat="server" ID="hdnAllAmount" Value='<%# Eval("Amount")%>' />
                                                </ItemTemplate>
                                                <FooterTemplate>
                                                    <asp:Label ID="lblFooterAllAmount" runat="server"></asp:Label>
                                                </FooterTemplate>
                                            ...
                                            <asp:TemplateField>
                                                <ItemTemplate>
                                                    <%--<asp:Label ID="lblCount" runat="server" Text='<%# Eval("Count")%>'></asp:Label>--%>
                                                    <asp:Label ID="lblActiveAmount" runat="server"></asp:Label>
                                                    <asp:HiddenField runat="server" ID="hdnActiveAmount" Value='<%# Eval("ActiveAmount")%>' />
                                                </ItemTemplate>
                                                <FooterTemplate>
                                                    <asp:Label ID="lblFooterActiveAmount" runat="server"></asp:Label>
                                                </FooterTemplate>
