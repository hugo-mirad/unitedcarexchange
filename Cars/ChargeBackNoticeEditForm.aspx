<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ChargeBackNoticeEditForm.aspx.cs"
    Inherits="ChargeBackNoticeEditForm" %>
    ...
    <script type="text/javascript" language="javascript">
     function echeck(str) {
       ...
       {         
           ...
           if(answer){             
              //alert('true');
              window.location.href = "CBNoticeClaims.aspx";                
           }
           else           
           {            
              return false;
                        ...
                        <table style="width: 380px; border-collapse: collapse;">
                            <tr>
                                <td style="width: 40px; vertical-align: top; padding-top: 6px;">
                                    <asp:Button ID="btnSave" runat="server" Text="Update" CssClass="g-button g-button-submit mt5"
