                            ...
                            <div class="article">
                                ...
                                <div class="col-xs-12 col-md-9">
                                    <div class="description">
                                        <p>
                                            No matter what situation you are in, financing a used vehicle is aroad we must all cross at some point in our lives. Whether you have good credit, bad credit, or none at all, you're just a click away from getting into your new ride! We at MobiCarz provide you various Financing options as listed below: </p>
                                    ...
                                    <div class="row description">
                                        ...
                                        <div class="col-sm-12 col-md-9">
                                            <h3><a href="http://www.nationwideautolending.com" target="_blank">www.nationwideautolending.com</a></h3>
                                            <p>You can get pre-approved for a new or used auto loan online with our free auto loan application. We specialize in bad credit auto loans and bad credit auto financing in all 50 states with our local auto finance credit centers.</p>
                                        </div>
                                    </div>
                                    
                                    <div class="row description">
                                        <div class="col-sm-12 col-md-3">    
                                              <div class="picture"><img src="imagesOld/RoadLoans.gif" style="float: left; margin: 0 10px 0 0">   </div>                         
                                        </div>
                                        <div class="col-sm-12 col-md-9">
                                        <h3><a href="http://www.roadloans.com" target="_blank">www.roadloans.com</a> </h3>  
                                            <p>RoadLoans is the internet auto lending division of Santander Consumer USA Inc. We specialize in financing and servicing new and used auto loans for customers with less than perfect credit.</p>
                                        </div>
                                    </div>
                                    <div class="row description">
                                        <div class="col-sm-12 col-md-3">    
                                             <div class="picture"><img src="imagesOld/AutoLoan.jpg" style="float: left; margin: 5px 10px 0 0">   </div>                           
                                        </div>
                                        <div class="col-sm-12 col-md-9">
                                        <h3><a href="http://www.autoloanlocator.com" target="_blank">www.autoloanlocator.com</a> </h3> 
                                            <p>What sets Auto Loan Locator apart from other online prime and sub prime lending locator companies offering similar services is our customer service. We are committed to building AAA auto loan lender relationships by understanding our customers’ needs and striving to deliver solutions to meet those needs.</p>
                                        </div>
                                    </div>
                                    <div class="row description">
                                        <div class="col-sm-12 col-md-3">    
                                            <div class="picture"><img src="imagesOld/Second.jpg" style="float: left; margin: 5px 10px 0 0"> </div>                              
                                        </div>
                                        <div class="col-sm-12 col-md-9">
                                        <h3><a href="http://www.secondcarloans.com" target="_blank">www.secondcarloans.com</a> </h3> 
                                            <p>We Specialize in used car loans Travel in the luxury of a car of your own and make your dream car a reality. Even if you have a history of bad credit, no credit, bankruptcy or repossession, we can get you financed for your used car.</p>
                                        </div>
                                    </div>
