...
<body id="page1">
    <form id="form1" runat="server">
                    ...
                    <div class="row">
                        <div class="col-md-12 clearfix">
                            <div class="brand">
                                ...
                                <div class="slogan">
                                    The best way to sell/buy a car in your local area and<br />
                            ...
                            <nav class="collapse navbar-collapse navbar-collapse" role="navigation">
                                <ul class="navigation">
                                    ...
                                    <li runat="server" visible="false" id="logoutLi">
                                        <asp:LinkButton ID="lnkBtnLogout" runat="server" CssClass="login" Text="<i class='icon icon-normal-turn-off'></i> Logout" OnClick="lnkBtnLogout_Click"></asp:LinkButton></li>
                                </ul>
                                <!-- /.nav -->
                            </nav>
                        </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="contact pull-right">
                            <div class="contact-item mail">
                                ...
                                <!-- /.label -->
                                <div class="value">
                                    <a href="mailto:example@example.com">info@mobicarz.com</a>
                                </div>
                                <!-- /.value -->
                            </div>
                            <div class="contact-item phone">
                                ...
                                <!-- /.label -->
                                <div class="value">
                                    888-465-6693 <small>(Mon - Fri : 9:00 AM - 5:00 PM)</small>
                                </div>
                                <!-- /.value -->
                            </div>
                            <!-- /.phone -->
                            ...
                            <div class="contact-item opening">
                                ...
                                <div class="value">
                                    <asp:UpdatePanel ID="usub" runat="server">
                                        <ContentTemplate>
                                            <asp:Button ID="btnsubscr" runat="server" Text="Sign Up For Alerts" Style="margin-bottom: 2px; margin-left: 25px;"
                                                class="btn btn-danger  btn-xs " OnClick="btnsubscr_click" />
                                        </ContentTemplate>
                                    </asp:UpdatePanel>
                                </div>
                                <!-- /.value -->
                                            ...
                                            <div class="inner">
                                                <table style="width: 100%;">
                                                    <tbody>
                                                        <tr>
                                                            <td colspan="2">
                                                                <asp:UpdatePanel ID="updpnl" runat="server">
                                                                    <ContentTemplate>
                                                                        <div class="soldCar block white block-shadow" id="soldCar" runat="server" style="margin: 20px 0; padding: 15px; border: #d9a863 3px dashed; background: #fffed1">
                                                        ...
                                                        <tr style="display: none;" id="soldcardeta" runat="server">
                                                            <td style="width: auto; vertical-align: top">
                                                                <div class="sellerInfo1">
                                                                    <strong>Phone: &nbsp;</strong><asp:Label runat="server" ID="Label1"></asp:Label>
                                                                    <br />
                                                                    <strong>Email: &nbsp;</strong> <a id="A2" runat="server" href="javascript: emailSend()">Send an email to seller</a>
                                                                    <br />
                                                                </div>
                                                            </td>
                                                    ...
                                                    <div class="block white block-shadow">
                                                        <div class="block-inner">
                                                            <div id="overview" class="active">
                                                                <div class="row">
                                                                    <div class="col-sm-5 " id="soldcarid" runat="server">
                                                                    ...
                                                                    <!-- /.col-md-5 -->
                                                                    <div class="col-sm-7 " id="soldcarid2" runat="server">
                                                                        <h3>
                                                                        ...
                                                                        <table class="table">
                                                                            <tbody>
                                                                                ...
                                                                                <tr>
                                                                                    <td class="property">Exterior Color
                                                                                    </td>
                                                                                    <td class="value">
                                                                                ...
                                                                                <tr>
                                                                                    <td class="property">Interior Color
                                                                                    </td>
                                                                                    <td class="value">
                                                                                ...
                                                                                <tr>
                                                                                    <td class="property">Vehicle Condition
                                                                                    </td>
                                                                                    <td class="value">
                                                                                ...
                                                                                <tr>
                                                                                    <td class="property">Fuel Economy
                                                                                    </td>
                                                                                    <td class="value">
                                                                                ...
                                                                                <tr>
                                                                                    <td class="property">Transmission
                                                                                    </td>
                                                                                    <td class="value">
                                                                ...
                                                                <div class="info">
                                                                    ...
                                                                    <div class="box30" style="display: none;">
                                                                        <h3 class="det-h2">Surrounding towns</h3>
                                                                        <div class="inner">
                                                                ...
                                                                <div class="col-md-12 col-sm-12">
                                                                    <div class="ask">
                                                                        <div class="form-group ">
                                                                            <!-- txtCondition  -->
                                                                            <span id="oeFormsellingPointsContainer"><span id="sellingPointSentence" style="display: inline-block; margin: 0; font-weight: normal; font-size: 12px;"><span id="sellingPointCharCount">300</span>
                    ...
                    <div style="width: 380px; float: left;">
                        ...
                        <div style="width: 90px; float: left">
                            <input type="button" class="pull-left btn btn-default" id="btnCancelPW" value="Cancel"
                                onclick="javascript: return cancel1();" />
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <tr>
                            <td style="padding-top: 5px;" colspan="2">
                                <div style="width: 34px; margin: 30px auto 0 auto">
                                    <asp:Button ID="btnOk1" runat="server" class="btn btn-primary2" Text="Ok" OnClick="btnOk1_Click" />
                                </div>
                            </td>
                        </tr>
                    </table>
        ...
        <div id="subScribUs111" class="alert" style="height: auto; padding-bottom: 15px; max-width: 550px; width: 70%; display: none;">
            <h4 id="">Sign up to receive email alerts.
        ...
        <div id="Buyacarpopup" class="alert" style="height: auto; padding-bottom: 15px; max-width: 550px; width: 70%; display: none;">
            <h4 id="H2">Buy A Car
        ...
        <div id="mdlPopDetailPage" class="alert Special" style="height: auto; padding-bottom: 15px; max-width: 550px; width: 100%; display: none;">
            <h4 id="H3">Can i call you to make a best offer on this car?
