...
namespace CarsBL.Transactions
{
    public class SmartzIntroMail
    {
        ...
        public DataSet RvsGetIntroMailDetailsFor15Days()
        {
            try
            {
                DataSet dsMails = new DataSet();
        ...
        public bool USP_SaveIntroMailDetails(string MarketSpecialist, string CustomerEmail,string Language)
        {
            try
            {
                bool bnew = false;
        ...
        public bool RvsSaveIntroMailDetails(string MarketSpecialist, string CustomerEmail)
        {
            try
            {
                bool bnew = false;
