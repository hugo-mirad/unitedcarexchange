...
{
    public class TrucksUserRegistrationInfo
    {
        private int _UId;
        ...
        private int _SaleAgentID;


        public int SaleAgentID
        {
            get { return _SaleAgentID; }
            set { _SaleAgentID = value; }
        }
        private int _VerifierID;


        public int VerifierID
        {
            get { return _VerifierID; }
            set { _VerifierID = value; }
        }
