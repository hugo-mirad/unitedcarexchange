...
public class Photo extends Activity {
	...
	public class MyTask extends AsyncTask<String, Integer, String> {
		protected String doInBackground(String... arg0) {
			...
			// System.out.println("this is session photo" +
			// Seller_Login.SessionID);
